...
order by
    ...
    fig.add_trace(go.Scatter(x=y,y=SanDiego[1], name="Crimes Per 100K"), secondary_y=False)
    fig.add_trace(go.Scatter(x=y,y=SanDiego[0], name="Crimes"), secondary_y=True)
    fig.update_layout(title_text="San Diego County Crimes per 100K and Median Income")
    fig.update_xaxes(title_text="Year")
    fig.update_yaxes(title_text="Crimes (Per 100K)", secondary_y=False)
    fig.update_yaxes(title_text="Median Income", secondary_y=True)
    ...
    # fig.add_trace(go.Scatter(x=y, y=Orange[0], name="Income"), row=1, col=1, secondary_y=True)

    # fig.add_trace(go.Scatter(x=y, y=Riverside[1], name="Crimes"), row=1, col=2, secondary_y=False)
    # fig.add_trace(go.Scatter(x=y, y=Riverside[0], name="Income"), row=1, col=2, secondary_y=True)

    # fig.add_trace(go.Scatter(x=y, y=Alameda[1], name="Crimes"), row=1, col=3, secondary_y=False)
    # fig.add_trace(go.Scatter(x=y, y=Alameda[0], name="Income"), row=1, col=3, secondary_y=True)

    # fig.add_trace(go.Scatter(x=y, y=LosAngeles[1], name="Crimes"), row=2, col=1, secondary_y=False)
    # fig.add_trace(go.Scatter(x=y, y=LosAngeles[0], name="Income"), row=2, col=1, secondary_y=True)

    # fig.add_trace(go.Scatter(x=y, y=SanDiego[1], name="Crimes"), row=2, col=2, secondary_y=False)
    # fig.add_trace(go.Scatter(x=y, y=SanDiego[0], name="Income"), row=2, col=2, secondary_y=True)

    # fig.add_trace(go.Scatter(x=y, y=SantaClara[1], name="Crimes"), row=2, col=3, secondary_y=False)
    # fig.add_trace(go.Scatter(x=y, y=SantaClara[0], name="Income"), row=2, col=3, secondary_y=True)
